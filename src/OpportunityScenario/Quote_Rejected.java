...
public class Quote_Rejected{
	...
	WebDriver driver;
	public Quote_Rejected(WebDriver driver) {
	...
	public void Quote_Rejecte() throws InterruptedException {
		Thread.sleep(4000);
		// TODO Auto-generated method stub
		boolean isEnabled = driver.getPageSource().startsWith("Corp Moody");
		//boolean isDisplayed = driver.getPageSource().startsWith("CorpMoody");

		if (isEnabled) 
			System.out.println(" Check Quote Rejected");  	
		else {
			System.out.println(" Check Quote Rejected");
		}
	}
